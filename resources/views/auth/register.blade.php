    ...
    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
        ...
        <div class="row">
            <div class="medium-9 columns">
                ...
                <a href="/login/facebook" class="button facebook"><i class="fi-social-facebook"></i> Iniciar sesión en
                    Facebook</a>
                <hr class="green">
                <div class="row">
                    <div class="medium-6 columns">
                        <label>Tipo de identificación
                            ...
                            <select name="identification_type"
                                    class="{{ $errors->has('identification_type') ? ' is-invalid-input' : '' }}">
                    ...
                    <div class="medium-6 columns">
                        <label>
                            ...
                            <input type="text" name="identification"
                                   class="{{ $errors->has('identification') ? ' is-invalid-input' : '' }}"
                ...
                <div class="row">
                    <div class="medium-6 columns">
                        <label>
                            Nombres
                            <input type="text" name="name" class="{{ $errors->has('name') ? ' is-invalid-input' : '' }}"
                    ...
                    <div class="medium-6 columns">
                        <label>
                            Apellidos
                            <input type="text" name="last" class="{{ $errors->has('last') ? ' is-invalid-input' : '' }}"
                                   value="{{ old('last') }}">
                            @if ($errors->has('last'))
                ...
                <fieldset class="row columns hide">
                    ...
                    <input type="radio" name="gender" value="M" id="gender_m" {{ old('gender','M')=='M'?'checked':'' }}><label
                            for="gender_m">Masculino</label>
                    <input type="radio" name="gender" value="F" id="gender_f" {{ old('gender','M')=='F'?'checked':'' }}><label
                            for="gender_f">Femenino</label>
                ...
                <div class="row columns">
                    ...
                    <input id="promotions" name="promotions" type="checkbox"
                           {{ old('promotions')?'checked':'' }} value="1"><label for="promotions">Si, deseo recibir
                        promociones</label>
                </div>
                <hr>
                <hr class="light">
                <div class="row columns">
                    <p>Al continuar estás aceptando los <a target="_blank" href="/terminos-y-condiciones">términos y
                            condiciones</a> de la plataforma.</p>
                </div>
