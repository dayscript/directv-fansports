                                ...
                                <tr>
                                    ...
                                    <td class="no-sort no-click">
                                        ...
                                        @if (Voyager::can('read_'.$dataType->name))
                                            <a href="/predictions/{{ $data->id }}/calculatepoints" target="_blank" class="btn-sm btn-primary pull-right edit">
                                                Calculate points
                                            </a>
                                            @if($data->opta_id)
                                                <a href="/matches/{{ $data->id }}/updatescore" target="_blank" class="btn-sm btn-primary pull-right edit">
                                                    Update score
                                                </a>
                                            @else
                                                    <a disabled="true" href="" class="btn-sm btn-primary pull-right edit is-disabled">
                                                        Update score
                                                    </a>
                                            @endif
